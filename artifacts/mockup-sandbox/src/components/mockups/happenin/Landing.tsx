  ...
  return (
    <footer style={{ background: '#000', borderTop: '1px solid rgba(255,255,255,0.07)' }}>
      <div style={{ padding: '72px 72px 24px', display: 'grid', gridTemplateColumns: 'minmax(320px, 1fr) minmax(360px, 560px)', gap: 72, alignItems: 'start' }}>
        <div style={{ fontFamily: F, color: '#fff', display: 'grid', gridTemplateColumns: 'repeat(3, minmax(0, 1fr))', gap: 36, paddingLeft: 16 }}>
          <div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 16, paddingRight: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 10, width: '100%', maxWidth: 360 }}>
      ...
      <div style={{ position: 'relative', height: 520, overflow: 'hidden', background: '#000', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, width: '100%', padding: '0 32px 0 32px', transform: 'translateY(18px)' }}>
