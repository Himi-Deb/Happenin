            ...
            <div style={{ position: 'relative', zIndex: 1, padding: '16px 32px 14px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{ display: 'flex', gap: 6 }}>
                {[
                  ...
                  <div key={i} style={{ width: 32, height: 32, borderRadius: 9, background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: 'rgba(255,255,255,0.28)' }}>{ico}</div>
                ))}
              </div>
            </div>
          </div>
