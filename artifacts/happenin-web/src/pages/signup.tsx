  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: '#000', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '60px 80px', position: 'relative', overflowY: 'auto' }}>
        <button type="button" aria-label="Close signup" style={{ position: 'absolute', top: 28, right: 28, width: 42, height: 42, borderRadius: '50%', border: '1px solid rgba(255,255,255,0.12)', background: 'rgba(255,255,255,0.04)', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }} onClick={() => navigate('/')}>
          {CLOSE}
        </button>
        ...
        <div className="su-form-in" style={{ width: '100%', maxWidth: 400, display: 'flex', flexDirection: 'column' }}>
          <div style={{ marginBottom: 32 }}>
            ...
            <p style={{ fontFamily: F, fontSize: 15, color: 'rgba(255,255,255,0.35)', margin: '10px 0 0', fontWeight: 400 }}>
              Already have one?{' '}
              <a onClick={(e) => { e.preventDefault(); navigate('/login'); }} href="#" style={{ color: '#7FE0D5', textDecoration: 'none', fontWeight: 600 }}>Sign in</a>
            </p>
          </div>
          ...
          <div style={{ display: 'flex', gap: 12, marginBottom: 28 }}>
            {[
              ...
              <button key={s.label} className="su-social-btn" onClick={() => navigate('/confirmation')} style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 14, padding: '13px 0', color: '#fff', fontFamily: F, fontSize: 14, fontWeight: 600, cursor: 'pointer', transition: 'background 0.15s' }}>
                {s.icon}
                {s.label}
              </button>
            ))}
